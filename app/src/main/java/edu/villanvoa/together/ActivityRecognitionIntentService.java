...
//            }
            ...
            String userStatus = sharedPreferences.getString("UserStatus", null);
            Log.d(TAG, "Status: " + getNameFromType(activityType));
            if (((userStatus == null) || (!userStatus.equals(getNameFromType(activityType)))) && (!getNameFromType(activityType).equals("Unknown"))) {
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("UserStatus", getNameFromType(activityType));
                Log.d(TAG, getNameFromType(activityType));
                editor.apply();
                ...
                if (userId != null) {
                    ...
                    try {
                        ParseObject userObject = queryAll.getFirst();
                        userObject.put("UserStatus", getNameFromType(activityType));
                        userObject.save();
